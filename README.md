This is an app that allows its users to view their Twitter timeline using the [Twitter API](https://dev.twitter.com/rest/public). Users can also make new posts on their timeline through this app.
